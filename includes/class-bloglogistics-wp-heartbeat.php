<?php
/**
 * Main BlogLogistics WP Heartbeat class.
 *
	...
	final class BlogLogistics_WP_Heartbeat {
		...
		public function load_textdomain(): void {
			load_plugin_textdomain(
				...
				false,
				dirname( plugin_basename( BLOGLOGISTICS_WPH_FILE ) ) . '/languages'
			);
		}
								...
								<tr class="bloglogistics-wph-field" data-context="<?php echo esc_attr( $context ); ?>">
									...
									<td>
										<input
											...
											style="width: 100px;"
											<?php echo $is_disabled ? 'readonly="readonly"' : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
										/>
